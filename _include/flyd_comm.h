...
#ifndef __FLYD_COMM_H__
#define __FLYD_COMM_H__

//宏定义------------------------------------
// 每个包的最大长度【包头+包体】不超过这个数字，为了留出一些空间，实际上编码是，
// 包头+包体长度必须不大于 这个值-1000【29000】
#define _PKG_MAX_LENGTH     30000//实际最大值应该是 _PKG_MAX_LENGTH - 1000
...
//这个数字大小一定要 >sizeof(COMM_PKG_HEADER) ,所以我这里定义为20绰绰有余；
